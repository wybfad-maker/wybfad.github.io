  ...
  e.WxLogin = function (o) {
    ...
    (a += o.style ? '&style=' + o.style : ''),
      ...
      'auto' === o.color_scheme
        ...
        : 'dark' === o.color_scheme
          ? (a += '&color_scheme=dark')
          : 'light' === o.color_scheme && (a += '&color_scheme=light'),
      (r.src = a),
      (r.frameBorder = '0'),
    ...
    if (((c.innerHTML = ''), c.appendChild(r), e.addEventListener && e.JSON)) {
        ...
        if ('https://open.weixin.qq.com' === t.origin)
          try {
            ...
            e.console &&
              ...
              e.console.log('wxLogin postMessage error', t);
          }
      };
      ...
      o.onCleanup = function () {
        !l &&
          ...
          (e.removeEventListener('message', i, !1), (l = !0));
      };
    }
  };
})(window, document);
